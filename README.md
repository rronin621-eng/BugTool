...
首次打开 `.command` 文件或 Electron 应用时，macOS 可能会阻止运行未验证的软件。解决方法：

1. 双击文件后如果弹出「无法打开」提示，点击「好」
2. 打开 **系统设置 → 隐私与安全性**
3. 滚动到底部，会看到「已阻止"xxx"打开」的提示，点击 **仍要打开**
4. 或者右键点击文件 → 选择「打开」→ 在弹窗中点击「打开」

也可以在终端一次性解除限制：
```bash
xattr -cr /path/to/BugTool
```
